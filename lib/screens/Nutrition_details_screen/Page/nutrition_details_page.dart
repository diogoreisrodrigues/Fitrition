...
import 'package:fitness_flutter/screens/start_recipe/page/start_recipe_page.dart';
...
import 'package:fitness_flutter/screens/Nutrition_details_screen/widget/nutrition_details_content.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:fitness_flutter/core/extensions/list_extension.dart';

class NutritionDetaisPage extends StatelessWidget {
  final WorkoutData recipes;
  NutritionDetaisPage({required this.recipes});
      ...
      child: BlocConsumer<WorkoutDetailsBloc, WorkoutDetailsState>(
        ...
        builder: (context, state) {
          return Scaffold(
              ...
              body: NutritionDetailsContent(recipe: recipes));
        },
