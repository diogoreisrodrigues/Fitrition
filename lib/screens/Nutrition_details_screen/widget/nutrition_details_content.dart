...
import 'package:fitness_flutter/screens/Nutrition_details_screen/widget/panel/nutrition_details_panel.dart';
import 'package:fitness_flutter/screens/workout_details_screen/widget/workout_details_body.dart';
import 'package:flutter/material.dart';
import 'package:sliding_up_panel/sliding_up_panel.dart';

class NutritionDetailsContent extends StatelessWidget {
  final WorkoutData recipe;

  const NutritionDetailsContent({required this.recipe});
  ...
  Widget _createSlidingUpPanel(BuildContext context) {
    return SlidingUpPanel(
      panel: NutritionDetailsPanel(recipe: recipe),
      body: WorkoutDetailsBody(workout: recipe),
      //dark
